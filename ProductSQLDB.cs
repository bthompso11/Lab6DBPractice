...
namespace EventDBClasses
{
    public class ProductSQLDB : DBBase , IReadDB, IWriteDB
    {
        ...
        /// <summary>
        /// retrieves item from the data base
        /// </summary>
        ...
        /// <summary>
        /// Retrieves all of the records of the database
        /// </summary>
        ...
        /// <summary>
        /// deletes the record selected from the database
        /// </summary>
        /// <param name="p"></param>
        ...
        /// <summary>
        /// update selected record from the database
        /// </summary>
        /// <param name="p"></param>
        /// <returns>bool</returns>
